...
#if __has_include("ux_dcd_stm32.h")
#include "ux_dcd_stm32.h"
#endif
#endif

extern UINT ux_dcd_stm32_initialize(ULONG dcd_io, ULONG dcd_handle) __attribute__((weak));
...
static VOID app_ux_device_thread_entry(ULONG thread_input)
{
  ...
  if (ux_dcd_stm32_initialize != UX_NULL)
  {
    (void)ux_dcd_stm32_initialize((ULONG)USB, (ULONG)&hpcd_USB_FS);
